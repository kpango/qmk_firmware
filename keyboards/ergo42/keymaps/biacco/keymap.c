 ...
 * | Ctrl |   Z  |   X  |   C  |   V  |   B  |  {   |   |  }   |   N  |   M  |   ,  |   .  |   /  |  \   |
 * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
 * | GUI  |   $  |   !  |   ?  |ESC/  |Space/|Tab/  |   |Back  |Enter/| Del  |   &  |   %  |  *   |  =   |
 * |      |      |      |      |~SYMB |Shift |RCtrl |   |Space |~META |      |      |      |      |      |
 * `------------------------------------------------'   `------------------------------------------------'
 */
...
[BASE] = KEYMAP( \
  ...
  KC_LCTRL, KC_Z,    KC_X,    KC_C,       KC_V,             KC_B,           S(KC_LBRC),     S(KC_RBRC), KC_N,             KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_BSLS, \
  KC_LGUI,  KC_DLR,  KC_EXLM, S(KC_SLSH), LT(SYMB, KC_ESC), SFT_T(KC_SPC),  RCTL_T(KC_TAB), KC_BSPC,    LT(META, KC_ENT), KC_DEL,  KC_AMPR,  KC_PERC,  KC_ASTR,  KC_EQL \
),
