 ...
 * | Sft  |   Z  |   X  |   C  |   V  |   B  |  {   |   |  }   |   N  |   M  |   ,  |   .  |   /  |  \   |
 * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
 * | Ctrl | GUI  |  App |PrtSc |ESC/  |Space/|Tab/  |   |Back  |Enter/| Del  |   +  |   -  |  *   |  =   |
...
[BASE] = KEYMAP( \
  ...
  KC_LCTRL, KC_LGUI, KC_EXLM, S(KC_SLSH), LT(SYMB, KC_ESC), RCTL_T(KC_TAB), SFT_T(KC_SPC), KC_BSPC,    LT(META, KC_ENT), KC_DEL,  KC_AMPR,  KC_PERC,  KC_ASTR,  KC_EQL \
),
